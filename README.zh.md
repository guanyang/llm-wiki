...
│       ├── SKILL.md       # 四个子命令：ingest/query/lint/publish
...
| **知识查询（Query）** | 基于 wiki 已编译知识综合回答，优先引用高置信度页面，有价值的回答可归档 |
...
| Query | `/llm-wiki query <问题>` | 基于 Wiki 已编译知识回答，优先高置信度页面，有价值的回答可存回 Wiki |
